...
public class Erc20Utils {
     ...
     * @throws Exception
     */
    public  String transferERC20Token(Web3j web3, String to, BigInteger value, String contractAddress, Credentials credentials, byte chainId) throws Exception {
...
//        System.out.println("balance=="+balance);
        ...
        return signAndSend(web3, nonce, gasPrice, gasLimit, contractAddress, BigInteger.ZERO, funcABI, chainId, privateKey).getTransactionHash();
     ...
     * @return
     */
    public  EthSendTransaction signAndSend(Web3j web3j, BigInteger nonce, BigInteger gasPrice, BigInteger gasLimit, String to, BigInteger value, String data, byte chainId, String privateKey) {
...
//                System.out.println(JSON.toJSONString(send));
     ...
     * @return
     */
    public  BigInteger getTokenTotalSupply(Web3j web3j, String from,String contractAddress) {
     ...
     * @return
     */
    public  int getTokenDecimals(Web3j web3j, String from,String contractAddress) {
     ...
     * @return
     */
    public  String getTokenSymbol(Web3j web3j, String from,String contractAddress) {
     ...
     * @return
     */
    public  String getTokenName(Web3j web3j, String from,String contractAddress) {
...
//        System.out.println(nbalance);
     ...
     * 获取地址，公私钥
     */
    public JSONObject getAddPrivPub(String password,String text){
        String path = "data/ETH.json";
