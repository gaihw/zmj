...
//        return null;
    ...
    public  String gettxout(String txid,String vout){
        ...
        return httpUtils.postByJson("http://"+Config.DASH_URL+":"+Config.DASH_PORT,cred,params);
    }
    /**
     * getpeerinfo
     * @return
    ...
    public  String signrawtransactionwithkey(String hex,String txid,String vout,String scriptPubKey,String value,String privatekey){
        Base64.Encoder encoder = Base64.getEncoder();
        String cred = encoder.encodeToString((Config.BTC_USERNMAME + ":" + Config.BTC_PASSWORD).getBytes());
//        String params = "{\"jsonrpc\": \"1.0\", \"id\": \"curltest\", \"method\": \"signrawtransaction\", \"params\": [\""+hex+"\", [\""+privatekey+"\"],[{\"txid\":\""+txid+"\",\"vout\":"+vout+",\"scriptPubKey\":\""+scriptPubKey+"\",\"amount\":"+value+"}]]}";
